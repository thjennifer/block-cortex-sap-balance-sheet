- dashboard: income_statement_mktplace_report_table
  ...
  - title: profit and loss table
    ...
    label|profit_and_loss_fiscal_periods_selected_sdt.difference_percent: Var %
    ...
    heading|profit_and_loss.gllevel_number: "."
    hide|profit_and_loss.gllevel_number: true
    label|profit_and_loss.glparent_text: "."
    heading|profit_and_loss.glparent_text: ''
    hide|profit_and_loss.glparent_text: false
    label|profit_and_loss.glnode_text: "."
